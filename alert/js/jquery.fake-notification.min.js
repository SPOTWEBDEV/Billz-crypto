/* ========= INFORMATION ============================
 ...
 !function(a) {"use strict"; a.fn.Notification = function (b) 
	{ var c = a.extend({ Varible1: ["Thabo", "Sipho", "Lerato", "Nomsa", "Kabelo", "Mpho", "Jabulani", "Zanele", "Sizwe", "Lebogang", "Hendri", "Putri", "Ayu", "Somchai", "Wei Ling"], Varible2: ["Johannesburg", "Cape Town", "Durban", "Pretoria", "Bloemfontein", "Bangkok", "Singapore", "Jakarta", "Chiang Mai"], Amount: [100, 2500], 
	...
	AnimationEffectClose: 'fadeOut', Number: 3 }, b); return this.each(function () { var self = this; var number = 0; 
